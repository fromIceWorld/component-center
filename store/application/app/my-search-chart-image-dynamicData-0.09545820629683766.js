    ...
    customElements.define('my-search-chart-image-dynamicData',
      class MyComponent extends HTMLElement{
        template = `<div style="display:flex;flex-direction:column;padding-top:10px;padding-right:10px;padding-bottom:10px;padding-left:10px;width:100%;"><div style="display:flex;flex-direction:row;padding-top:10px;padding-right:10px;padding-bottom:10px;padding-left:10px;width:100%;"><my-text-2938756129093747 _data="_ngElementStrategy.componentRef.instance"
                         _methods="_ngElementStrategy.componentRef.instance" 
                        style="font-size:14px;color:black;"></my-text-2938756129093747><my-input-07179096052883738 _data="_ngElementStrategy.componentRef.instance" _methods="_ngElementStrategy.componentRef.instance"
                    type="text" 
               ></my-input-07179096052883738><my-text-6281074255530508 _data="_ngElementStrategy.componentRef.instance"
                         _methods="_ngElementStrategy.componentRef.instance" 
                        style="font-size:14px;color:black;"></my-text-6281074255530508><my-radio-4948810097332439 _data="_ngElementStrategy.componentRef.instance" _methods="_ngElementStrategy.componentRef.instance"></my-radio-4948810097332439><my-text-4678470686769465 _data="_ngElementStrategy.componentRef.instance"
                         _methods="_ngElementStrategy.componentRef.instance" 
                        style="font-size:14px;color:black;"></my-text-4678470686769465><my-select-15481295382324012 _data="_ngElementStrategy.componentRef.instance" _methods="_ngElementStrategy.componentRef.instance"></my-select-15481295382324012><my-icon-31196989106032214 _data="_ngElementStrategy.componentRef.instance" 
                        _methods="_ngElementStrategy.componentRef.instance"></my-icon-31196989106032214><my-button-11745386870064056 _data="_ngElementStrategy.componentRef.instance" _methods="_ngElementStrategy.componentRef.instance"></my-button-11745386870064056></div><div style="padding-top:10px;padding-right:10px;padding-bottom:10px;padding-left:10px;width:100%;"><my-table-5084619571332996 _data="_ngElementStrategy.componentRef.instance" _methods="_ngElementStrategy.componentRef.instance"></my-table-5084619571332996></div><div style="padding-top:10px;padding-right:10px;padding-bottom:10px;padding-left:10px;width:100%;"><line-chart-14989260054916675></line-chart-14989260054916675></div><div style="padding-top:10px;padding-right:10px;padding-bottom:10px;padding-left:10px;width:100%;"><my-image-5511957607765612 _data="_ngElementStrategy.componentRef.instance"
                        _methods="_ngElementStrategy.componentRef.instance" 
                       style="classes:undefined;style:undefined;"></my-image-5511957607765612></div></div><my-api-32365004699550237 _data="_ngElementStrategy.componentRef.instance" _methods="_ngElementStrategy.componentRef.instance"></my-api-32365004699550237>`;
        constructor(){
          super();
    ...
    class MyText2938756129093747 extends TextComponent{
              constructor(){
                  super();
                  this.text = '姓名'
                  this.dep();
          ...
          MyText2938756129093747.ɵcmp.factory = () => { return new MyText2938756129093747()};
          customElements.define('my-text-2938756129093747',createCustomElement(MyText2938756129093747, {  injector: injector,}));
          class MyInput07179096052883738 extends InputComponent{
            constructor(){
                super();
        ...
        MyInput07179096052883738.ɵcmp.factory = () => { return new MyInput07179096052883738()};
        customElements.define('my-input-07179096052883738',createCustomElement(MyInput07179096052883738, {  injector: injector,}));
        class MyText6281074255530508 extends TextComponent{
              constructor(){
                  super();
                  this.text = '性别'
                  this.dep();
          ...
          MyText6281074255530508.ɵcmp.factory = () => { return new MyText6281074255530508()};
          customElements.define('my-text-6281074255530508',createCustomElement(MyText6281074255530508, {  injector: injector,}));
          class MyRadio4948810097332439 extends RadioComponent{
            constructor(){
                super();
        ...
        MyRadio4948810097332439.ɵcmp.factory = () => { return new MyRadio4948810097332439()};
        customElements.define('my-radio-4948810097332439',createCustomElement(MyRadio4948810097332439, {  injector: injector}));
        class MyText4678470686769465 extends TextComponent{
              constructor(){
                  super();
                  this.text = '朋友'
                  this.dep();
          ...
          MyText4678470686769465.ɵcmp.factory = () => { return new MyText4678470686769465()};
          customElements.define('my-text-4678470686769465',createCustomElement(MyText4678470686769465, {  injector: injector,}));
          class MySelect15481295382324012 extends SelectComponent{
            constructor(){
        ...
        MySelect15481295382324012.ɵcmp.factory = () => { return new MySelect15481295382324012()};
        customElements.define('my-select-15481295382324012',createCustomElement(MySelect15481295382324012, {  injector: injector}));
        class MyIcon31196989106032214 extends IconComponent{
             constructor(){
                 super();
                 this['fontSize'] = '16px'
this['icon'] = '#icon-tubiao'
         ...
         MyIcon31196989106032214.ɵcmp.factory = () => { return new MyIcon31196989106032214()};
         customElements.define('my-icon-31196989106032214',createCustomElement(MyIcon31196989106032214, {  injector: injector}));
         class MyButton11745386870064056 extends ButtonComponent{
               constructor(){
                   super();
                   this.disabled = false
this.ghost = false
...
this.name = 'search'
           ...
           MyButton11745386870064056.ɵcmp.factory = () => { return new MyButton11745386870064056()};
           customElements.define('my-button-11745386870064056',createCustomElement(MyButton11745386870064056, {  injector: injector,}));
           class MyTable5084619571332996 extends TableComponent{
             constructor(){
                 super();
                 this.bordered = false
this.loading = false
...
this.row = undefined;
         ...
         MyTable5084619571332996.ɵcmp.factory = () => { return new MyTable5084619571332996()};
         customElements.define('my-table-5084619571332996',createCustomElement(MyTable5084619571332996, {  injector: injector,}));
         class LineChart14989260054916675 extends LineChartComponent{
                    that;
                    constructor(){
                        super();
                        setTimeout(()=>{
...
series : [{"name":"销量","type":"line","data":[5,20,36,10,10,20,0]},{"name":"销量2","type":"line","data":[15,30,46,20,20,30,0]}],})
                ...
                customElements.define('line-chart-14989260054916675',LineChart14989260054916675);
                class MyImage5511957607765612 extends ImageComponent{
             constructor(){
                 super();
                 this.width = 'auto'
this.height = 'auto'
this.src = 'data:image/webp;base64,'
         ...
         MyImage5511957607765612.ɵcmp.factory = () => { return new MyImage5511957607765612()};
         customElements.define('my-image-5511957607765612',createCustomElement(MyImage5511957607765612, {  injector: injector,}));
         class MyAPI32365004699550237 extends RequestComponent{
               constructor(){
...
this.api = 'https://www.fastmock.site/mock/14c2723aefa052a75b2a6feeed0cf387/suger/records'
           ...
           MyAPI32365004699550237.ɵcmp.factory = () => { return new MyAPI32365004699550237()};
           customElements.define('my-api-32365004699550237',createCustomElement(MyAPI32365004699550237, {  injector: injector,}));
           ;
            (()=>{
                const sourceDOM = document.querySelector('my-button-11745386870064056'),
                    targetDOM = document.querySelector('my-api-32365004699550237'),
            ...
            (()=>{
              const sourceDOM = document.querySelector('my-api-32365004699550237'),
                    targetDOM = document.querySelector('my-table-5084619571332996'),
          ...
          (()=>{
            const sourceDOM = document.querySelector('my-radio-4948810097332439'),
                  targetDOM = document.querySelector('my-api-32365004699550237'),
                  sourcePath = (sourceDOM.getAttribute('_data')||'').split('.'),
                  targetPath = (targetDOM.getAttribute('_methods')||'').split('.');
            let sourceIns = sourcePath.length ? sourcePath.reduce((pre,key)=>key ? pre[key] : pre,sourceDOM) : sourceDOM,
          ...
          (()=>{
            const sourceDOM = document.querySelector('my-select-15481295382324012'),
                  targetDOM = document.querySelector('my-api-32365004699550237'),
                  sourcePath = (sourceDOM.getAttribute('_data')||'').split('.'),
                  targetPath = (targetDOM.getAttribute('_methods')||'').split('.');
            let sourceIns = sourcePath.length ? sourcePath.reduce((pre,key)=>key ? pre[key] : pre,sourceDOM) : sourceDOM,
          ...
          (()=>{
            const sourceDOM = document.querySelector('my-input-07179096052883738'),
                  targetDOM = document.querySelector('my-api-32365004699550237'),
                  sourcePath = (sourceDOM.getAttribute('_data')||'').split('.'),
                  targetPath = (targetDOM.getAttribute('_methods')||'').split('.');
            let sourceIns = sourcePath.length ? sourcePath.reduce((pre,key)=>key ? pre[key] : pre,sourceDOM) : sourceDOM,
            ...
            (()=>{
              const sourceDOM = document.querySelector('my-api-32365004699550237'),
                    targetDOM = document.querySelector('line-chart-14989260054916675'),
                    sourcePath = (sourceDOM.getAttribute('_data')||'').split('.'),
                    targetPath = (targetDOM.getAttribute('_data')||'').split('.');
              sourceDOM.addEventListener('success200',()=>{
                let sourceIns = sourcePath.length ? sourcePath.reduce((pre,key)=>key ? pre[key] : pre,sourceDOM) : sourceDOM,
                    targetIns = targetPath.length ? targetPath.reduce((pre,key)=>key ? pre[key] : pre,targetDOM) : targetDOM;
                targetIns['config'] = sourceIns['lineChart'];
              })
            })();

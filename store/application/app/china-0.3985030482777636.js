    ...
    customElements.define('china',
      class MyComponent extends HTMLElement{
        template = `<div id="grid-50963625097281315000" style="z-index: 10;position: relative;"><div id='grid-50963625097281315000-0' style='border-top:1px solid #00000017;border-right:1px solid #00000017;border-bottom:1px solid #00000017;border-left:1px solid #00000017;border-radius:0px;padding:0px;background-color:#fff0;background-image:;background-repeat:no-repeat;background-size:cover;'></div></div><div style="width:100%;height:100%;position: absolute;"><china-map-chart-24867787210712322></china-map-chart-24867787210712322></div>`;
        constructor(){
          super();
    ...
    (()=>{
      const container = document.querySelector('#grid-50963625097281315000');
    ...
    function configGrid() {
        ...
        Object.keys(_gridItemsRenderData).forEach((key, index) => {
            ...
            children[index].style['width'] = width + 'px';
    ...
    })();class ChinaMapChart24867787210712322 extends ChinaMapChartComponent{
                    that;
                    constructor(){
                        super();
                        setTimeout(()=>{
                ...
                customElements.define('china-map-chart-24867787210712322',ChinaMapChart24867787210712322);
                ;
